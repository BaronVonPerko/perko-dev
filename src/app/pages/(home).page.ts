    ...
    <mat-card>
      ...
      <mat-card-content>
        <p>I'm Chris Perko, a Google Developer Expert in Angular!
          ...
          various events.</p>
        <p>I work as a Senior Enterprise Software Engineer for Briebug, building apps with Angular & NestJS.</p>
        <p>Although I live in Atlanta, I am a co-founder of <a href="https://gdg.community.dev/gdg-salt-lake-city/" target="_blank">the Salt Lake City Google Developer Group</a>, and <a href="https://devfestslc.web.app/" target="_blank">DevFest SLC!</a></p>
      </mat-card-content>
    </mat-card>
    <mat-card>
      <mat-card-header>
